...
public class InCabinetController extends RestController {
	private static final Logger logger = LoggerFactory.getLogger(InCabinetController.class);

	static String serviceId = "power_distribution_system";
	static String objectName = "h_voltage_in_cabinet";
